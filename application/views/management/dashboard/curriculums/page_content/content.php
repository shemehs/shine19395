<div class="margin-top-10">
	<?php
		...
		if($curriculums && is_array($curriculums) && count($curriculums)>0){
			...
			?>
			<p class="text-center"><label>No Curriculum(s) Yet. </label> <a href="<?php echo site_url("dashboard/curriculums/create"); ?>"><span class="glyphicon glyphicon-plus-sign"></span> <i>Create? </i></a></p>
			<?php
		}
	?>	
</div>