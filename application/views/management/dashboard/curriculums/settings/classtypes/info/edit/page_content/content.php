		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<?php
					...
					$form_hidden = array(sha1("editclasstype")=>sha1(random_string("alnum",5)));
					echo form_open("dashboard/curriculums/settings/classtypes/".(($classtypeinfo)?$classtypeinfo->getclasstypeid():0)."/edit",$form_attr,$form_hidden);
				?>
					...
					<div class="form-group <?php echo (has_error("classtypeCode")?"has-error":(has_success("classtypeCode")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="classtypeCode" type="text" id="classtypeCodeinput" class="form-control" value="<?php echo set_value("classtypeCode",(($classtypeinfo)?$classtypeinfo->class_type_code:"")); ?>" />
					...
					<div class="form-group <?php echo (has_error("classtypeAlias")?"has-error":(has_success("classtypeAlias")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="classtypeAlias" type="text" id="classtypeAliasinput" class="form-control" value="<?php echo set_value("classtypeAlias",(($classtypeinfo)?$classtypeinfo->class_type_alias:"")); ?>" />
					...
					<div class="form-group <?php echo (has_error("classtypeDescription")?"has-error":(has_success("classtypeDescription")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="classtypeDescription" type="text" id="classtypeDescriptioninput" class="form-control" value="<?php echo set_value("classtypeDescription",(($classtypeinfo)?$classtypeinfo->class_type_description:"")); ?>" />
							<?php echo ((has_message("classtypeDescription"))?'<span class="help-block">'.get_message("classtypeDescription").'</span>':""); ?>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-4">
							<button name="saveUpdateclasstype" type="submit" class="btn btn-primary"> Save </button>
							<a href="<?php echo site_url("dashboard/curriculums/settings/classtypes"); ?>" id="cancelUpdateclasstype" class="btn btn-danger rounded-corners-4px"> Cancel </a>
						<div>
					</div>
				</form>
			</div>
