	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<?php
					$courseinfo = isset($courseinfo)?$courseinfo:false;
					$form_attr = array("class"=>"form-horizontal");
					$form_hidden = array(sha1("editcourse")=>sha1(random_string("alnum",5)));
					echo form_open("dashboard/curriculums/settings/courses/".(($courseinfo)?$courseinfo->getCourseid():0)."/edit",$form_attr,$form_hidden);
				?>
					...
					<div class="form-group <?php echo (has_error("courseCode")?"has-error":(has_success("courseCode")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="courseCode" type="text" id="courseCodeinput" class="form-control" value="<?php echo set_value("courseCode",(($courseinfo)?$courseinfo->course_code:"")); ?>" />
						...
						<div class="col-sm-8">
							<?php
								$courseDescriptioninput = array(
								              ...
								              'value'  => set_value("courseDescription",(($courseinfo)?$courseinfo->course_description:"")),
								              'rows'   => '3'
								            );
