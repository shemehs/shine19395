		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<?php
					...
					$form_hidden = array(sha1("addsemester")=>sha1(random_string("alnum",5)));
					echo form_open("dashboard/curriculums/settings/semesters/add",$form_attr,$form_hidden);
				?>
					...
					<div class="form-group <?php echo (has_error("semesterCode")?"has-error":(has_success("semesterCode")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="semesterCode" type="text" id="semesterCodeinput" class="form-control" value="<?php echo set_value("semesterCode"); ?>" />
					...
					<div class="form-group <?php echo (has_error("semesterAlias")?"has-error":(has_success("semesterAlias")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="semesterAlias" type="text" id="semesterAliasinput" class="form-control" value="<?php echo set_value("semesterAlias"); ?>" />
					...
					<div class="form-group <?php echo (has_error("semesterDescription")?"has-error":(has_success("semesterDescription")?"has-success":"")); ?>">
						...
						<div class="col-sm-8">
							<input name="semesterDescription" type="text" id="semesterDescriptioninput" class="form-control" value="<?php echo set_value("semesterDescription"); ?>" />
