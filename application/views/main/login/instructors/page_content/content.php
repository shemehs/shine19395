	...
	<?php
		...
		$form_hidden = array(
						sha1("classschedulelogin")=>sha1("typeinstructor")
					);		
		$form_attr = array("class"=>"login-form","id"=>"loginform","name"=>"loginform");
		
		echo form_open('login/instructor',$form_attr,$form_hidden);
			...
			<div class="row">
				<div class='col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2'>
					...
					<div class="margin-bottom-0 form-group form-field-form-group  <?php echo ((has_error("passwordfield"))?"has-error":((has_success("passwordfield"))?"has-success":"")); ?>"  id="password-field-form-group">
						...
						<span id="passwordfield-help-block"  class="margin-bottom-0  padding-left-50 <?php echo has_message("passwordfield")?"":"sr-only"; ?> help-block"> <i class="  fa fa-exclamation-circle"></i> <span id="passwordfield-message"><?php echo (has_message("passwordfield")?get_error_message("passwordfield"):""); ?></span></span>
